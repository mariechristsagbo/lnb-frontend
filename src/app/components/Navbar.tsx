...
interface NavbarProps {
  className?: string;  // Le ? rend la prop optionnelle
}

const Navbar: React.FC<NavbarProps> = ({ className }) => {
  return (
    <header className={`${styles.navbar} navbar navbar-expand-lg ${className}`} style={{ backgroundColor: '#f8f9fa', height: '70px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
      <div className="container-fluid d-flex align-items-center justify-content-between">
        {/* Logo dans un conteneur sans lien */}
        <div className={`${styles.logoContainer} navbar-brand`} style={{ height: '50px' }}>
          <Image
