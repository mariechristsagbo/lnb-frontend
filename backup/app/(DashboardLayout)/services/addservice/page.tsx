...
export default function ServiceForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const userResponse = await fetch("https://www.backend.lnb-intranet.globalitnet.org/utilisateurs/list-users/", {
          headers
        });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://www.backend.lnb-intranet.globalitnet.org/services/create/", {
        method: "POST",
        headers: {
